...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'people_person', (
            ...
            ('gender', self.gf('django.db.models.fields.CharField')(default='male', max_length=7, null=True, blank=True)),
            ('birthdate', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('bio', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('profile_partially_completed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.create_table(u'people_person_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm[u'people.person'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(u'people_person_groups', ['person_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'Person'
        db.create_table(u'people_person_user_permissions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm[u'people.person'], null=False)),
            ('permission', models.ForeignKey(orm[u'auth.permission'], null=False))
        ))
        db.create_unique(u'people_person_user_permissions', ['person_id', 'permission_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('people_person_user_permissions')
